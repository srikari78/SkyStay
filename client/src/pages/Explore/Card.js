...
const Card = (props) => {
    ...
    return (
        <CardContainer>
            ...
            <Image style={{ backgroundImage: `url(${hotel.image ? hotel.image : images[Math.floor(Math.random() * images.length)]})`, minWidth: '260px', height: '260px' }} />
            <HotelDetails className="details">
                ...
                <Text className="small">Starting from $ 100</Text>
